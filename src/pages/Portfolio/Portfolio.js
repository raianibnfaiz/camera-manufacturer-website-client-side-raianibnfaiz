        ...
        <div className="mx-8">
            ...
            <div class="card mx-auto my-8 bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <p>Project 1 : Bicycle Warehouse Management Store (Go to Website:<a className='text-primary-focus mb-4' href='https://warehouse-management-92018.web.app/'>https://warehouse-management-92018.web.app/</a> )</p>
                    <p>Project 2 : Independent Photography Service (Go to Website:<a className='text-primary-focus mb-4' href='https://independent-service-prov-b72f0.web.app/'>https://independent-service-prov-b72f0.web.app/</a> )</p>
                    <p>Project 3 : Boots Shop Products Analysis (Go to Website:<a className='text-primary-focus mb-4' href='https://product-analysis-website-raianibnfaiz.netlify.app/home'>https://product-analysis-website-raianibnfaiz.netlify.app/home</a> )</p>
